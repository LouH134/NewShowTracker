...
//
///*Problems:
// 1. Only the name and rank of show is saved in firebase not everything else that coredata saves
// 2. Each Update is a new post to lists in firebase. Should I make each update a new post? or should I overwrite the old post?
// 3. Change User to coredata pull data from firebase
// */
///*TO DO:
...
//
//
//class CreateShowViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
//
